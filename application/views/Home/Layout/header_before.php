...
<div class="container-fluid header_con">
	...
	<div class="row">
		...
		<div class="col-md-2">
			<a  href="<?php echo site_url('home/search'); ?>">
				...
				<i class="fa fa-search srch_fa" aria-hidden="true"></i>
			</a>
		</div>
	...
	<hr>
	<div class="row drpdwn_pdng">
		<?php foreach ($category1 as $cat1){ ?>
			<div class="dropdown drpdwn_disp">
				<a class="dropdown-toggle drpdwn_a" data-toggle="dropdown">
					<?php echo $cat1->name_cat1 ?>
				<span class="caret"></span>
				</a>
				<ul class="dropdown-menu drpdwn_ul">
					<?php foreach ($category2 as $cat2){if ($cat2->id_cat1 == $cat1->id){ ?>
						<a class="drpdwn_ul_a" href="<?php echo base_url().'home/category2/'.$cat2->id.'/'.$cat2->name_cat2;?>">
						<li class="drpdwn_li"
						onmouseover="$(this).css({'background-color':'#ccc'})"
						onmouseleave="$(this).css({'background-color':'#fff'})">
						<?php echo $cat2->name_cat2; } ?></li>
						</a>
					<?php }?>
				</ul>
